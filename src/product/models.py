...
class ProductType(models.Model):
    ...
    def get_absolute_url(self) -> str:
        return reverse_lazy('product:product_type', args=[self.id])
...
class Product(models.Model):
    ...
    price = models.DecimalField(max_digits=8, decimal_places=2, null=False, blank=False, db_index=True, verbose_name='Цена')
